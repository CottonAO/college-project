...
<body>
    ...
    <div class="modal fade" id="auth" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('login')); ?>" method="post" id="authForm" onsubmit="ajaxForm(this, event)">
    ...
    <div class="modal fade" id="register" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('register')); ?>" method="post" id="registerForm" onsubmit="ajaxForm(this, event)">
                    <div class="modal-header">
        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto ms-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="<?php echo e(route('home')); ?>" class="nav-link px-2 text-secondary">Главная</a></li>
                    <li><a href="#" class="nav-link px-2 text-white">О нас</a></li>
                    <li><a href="<?php echo e(route('home')); ?>" class="nav-link px-2 text-white">Каталог</a></li>
                ...
                <div class="text-end">
                    ...
                    <a href="<?php echo e(route('logout')); ?>" class="btn btn-outline-light">Выход</a>
                    <?php else: ?>
...
</html><?php /**PATH C:\OpenServer\domains\deshop42\resources\views/layouts/main.blade.php ENDPATH**/ ?>